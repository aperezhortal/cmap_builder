...
The cmap_builder.build_cmap()` function provided by this package exposes a simple interface to create complex colormaps simply by specifying the colors at different points across the color scale. This approach was largely inspired by the way of defining colormaps in the `legs <https://domutils.readthedocs.io/en/stable/legsTutorial.html>`_ module in the
`domutils package <https://domutils.readthedocs.io>`_.
